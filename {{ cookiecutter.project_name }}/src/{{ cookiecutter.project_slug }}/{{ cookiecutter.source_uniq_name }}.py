...
class {{ cookiecutter.payload_name }}(S3PParserBase):
    """
    ...
    def __init__(self,
                 ...
                 {% if cookiecutter.use_selenium == 'y' %}web_driver: WebDriver{% endif %}):
    ...
    def _parse(self) -> None:
        """
        The place for general parser or other logic in s3p plugin
        :param self:
        :return:
        {}
        ...
        {}
        """
{% if cookiecutter.with_test_data == 'y' %}
